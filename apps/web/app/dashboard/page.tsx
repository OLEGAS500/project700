...
function StoreRow({ store }: { store: DashboardStoreSummary }) {
  ...
  return (
    <tr>
      ...
      <td className="dashboard-store-actions">
        <Link className="incident-list-link" href={"/incidents?storeId=" + encodeURIComponent(store.id)}>
          Incidents
        </Link>
        <Link className="incident-list-link" href={`/stores/${store.id}/maintenance`}>
          Maintenance
        </Link>
        ...
        <Link className="incident-list-link" href={`/stores/${store.id}/destinations`}>
          Destinations
        </Link>
        <Link className="incident-list-link" href={`/stores/${store.id}/merchant-center`}>
          Merchant Center
        </Link>
      </td>
    </tr>
